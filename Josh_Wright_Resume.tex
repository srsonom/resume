...
\geometry{letterpaper, margin=0.7in, top=0.5in}
% just in case I need even more space
\newcommand{\upspace}{\vspace{0.7px}}
...
\zzz{Projects:}
	\aaa CSCE 121: Wrote a clone of Minesweeper in C++ using the FLTK graphics library. 
